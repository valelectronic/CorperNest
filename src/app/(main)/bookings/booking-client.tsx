      ...
      <div style={{
        ...
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
          <path d="M3 9.5L12 3L21 9.5V20a1 1 0 01-1 1H4a1 1 0 01-1-1V9.5z"
            stroke="var(--color-text-muted)" strokeWidth="1.6" fill="none" strokeLinejoin="round" />
        </svg>
      </div>
    );
  }
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 100, display: "flex", flexDirection: "column", justifyContent: "flex-end" }}>
      ...
      <div style={{
        ...
        <div style={{
          width: 52, height: 52, borderRadius: 16, background: "var(--color-light)",
        ...
        <p style={{ fontSize: 13, color: "var(--color-text-secondary)", lineHeight: 1.6, margin: "0 0 24px" }}>
          Pick a date and time to inspect <strong>{booking.listingTitle}</strong>. Agent contact and full address will be revealed immediately.
        </p>
    ...
    <div style={{
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 8, marginBottom: 4 }}>
            <p style={{
              ...
              fontSize: 14, color: "var(--color-header)",
      ...
      <div style={{ padding: "12px 16px" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 10 }}>
          ...
          <span style={{ fontSize: 12, fontWeight: 700, fontFamily: "var(--font-mono)", color: "var(--color-text)" }}>
            {booking.bookingCode}
          </span>
        </div>
        ...
        {isScheduled && booking.listingAddress && (
          <div style={{
            background: "var(--color-bg)", borderRadius: 12, padding: "10px 12px",
            border: "1px solid var(--color-border)", marginBottom: 10,
          }}>
            <p style={{ margin: "0 0 4px", fontSize: 11, fontWeight: 600, color: "var(--color-text-muted)", textTransform: "uppercase", letterSpacing: "0.5px" }}>
              Property Address
            </p>
            ...
            <a
              href={`https://maps.google.com/?q=${encodeURIComponent(
                booking.listingAddress + " " + booking.listingLga + " " + booking.listingState
              )}`}
              target="_blank"
        ...
        {isScheduled && booking.agentName && (
          <div style={{
            ...
            <p style={{ margin: "0 0 6px", fontSize: 11, fontWeight: 600, color: "var(--color-text-muted)", textTransform: "uppercase", letterSpacing: "0.5px" }}>
              Agent Contact
            </p>
        ...
        {booking.status === "verified" && (
          <div style={{
            ...
            background: "#E8F5E9", border: "1px solid var(--color-border)",
          }}>
...
function EmptyBookings() {
  ...
  return (
    <div style={{ textAlign: "center", padding: "60px 24px" }}>
      <div style={{
        width: 64, height: 64, borderRadius: "50%", background: "var(--color-light)",
        display: "flex", alignItems: "center", justifyContent: "center",
        margin: "0 auto 16px",
      }}>
      ...
      <p style={{ fontFamily: "var(--font-heading)", fontSize: 16, fontWeight: 700, color: "var(--color-text)", margin: "0 0 6px" }}>
        No bookings yet
      </p>
    ...
    return (
      <div style={{ maxWidth: 600, margin: "0 auto", padding: "24px 16px" }}>
        ...
        {[1, 2].map((i) => (
          <div key={i} style={{
            background: "var(--color-card)", borderRadius: 18,
            border: "1px solid var(--color-border)", padding: 16, marginBottom: 14,
          }}>
    ...
    <div style={{ maxWidth: 600, margin: "0 auto", padding: "24px 16px" }}>
      ...
      <div style={{ marginBottom: 20 }}>
        <p style={{
          ...
          color: "var(--color-header)", margin: "0 0 4px",
        }}>
          My Bookings
        </p>
