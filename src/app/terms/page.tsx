...
// Terms of Service page — required for Paystack compliance review.
...
export const metadata: Metadata = {
  ...
  description: "Terms of Service for CorperNest, operated by Bridgenest Limited.",
};
      ...
      <div style={{ maxWidth: 640, margin: "0 auto" }}>
        ...
        <section style={{ marginBottom: 28 }}>
          ...
          <p style={{ fontSize: 14, color: "var(--color-text-secondary)", lineHeight: 1.8, margin: 0 }}>
            CorperNest is owned and operated by <strong>BRIDGENEST LIMITED</strong> (RC 9630078), a company registered in Nigeria. All commercial transactions, order processing, and payment collections on CorperNest are processed by BRIDGENEST LIMITED as the merchant of record.
          </p>
        </section>
        ...
        <section style={{ marginBottom: 28 }}>
          ...
          <ul style={{ fontSize: 14, color: "var(--color-text-secondary)", lineHeight: 1.9, margin: 0, paddingLeft: 20 }}>
            ...
            <li>Payments are securely processed via Paystack, a CBN-licensed payment gateway.</li>
            ...
            <li>CorperNest charges a 5% service fee on marketplace transactions, deducted from the seller payout.</li>
          </ul>
        </section>
        ...
        <section style={{ marginBottom: 28 }}>
          ...
          <ul style={{ fontSize: 14, color: "var(--color-text-secondary)", lineHeight: 1.9, margin: 0, paddingLeft: 20 }}>
            ...
            <li>Buyers must confirm delivery of items through the platform upon receipt.</li>
            <li>If an item is not received or is not as described, buyers must raise a dispute within 48 hours of expected delivery.</li>
            <li>Refund eligibility is determined by BRIDGENEST LIMITED after reviewing the dispute. Approved refunds are processed within 3–5 business days.</li>
        ...
        <section style={{ marginBottom: 28 }}>
          ...
          <ul style={{ fontSize: 14, color: "var(--color-text-secondary)", lineHeight: 1.9, margin: 0, paddingLeft: 20 }}>
            ...
            <li>Property inspection bookings are free. Buyers pay agents directly after inspection.</li>
            <li>CorperNest charges agents a platform service fee after a confirmed visit.</li>
          </ul>
        </section>
        ...
        <section style={{ marginBottom: 28 }}>
          ...
          <ul style={{ fontSize: 14, color: "var(--color-text-secondary)", lineHeight: 1.9, margin: 0, paddingLeft: 20 }}>
            ...
            <li>Listing stolen, counterfeit, or fraudulently obtained items is strictly prohibited and will be reported to the Nigeria Police Force and EFCC.</li>
            <li>Users may not use the platform to conduct transactions outside of CorperNest's checkout system.</li>
          </ul>
        </section>
        ...
        <section style={{ marginBottom: 40 }}>
          ...
          <p style={{ fontSize: 14, color: "var(--color-text-secondary)", lineHeight: 1.8, margin: 0 }}>
            For support, disputes, or enquiries, contact us at:<br />
        ...
        {/* Footer */}
        <div style={{ paddingTop: 24, borderTop: "1px solid var(--color-border)", display: "flex", gap: 20 }}>
