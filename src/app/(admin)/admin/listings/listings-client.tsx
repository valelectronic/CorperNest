    ...
    <div style={{ padding: "24px 16px 64px", maxWidth: 800, margin: "0 auto" }}>
      ...
      {items.length === 0 ? (
        <div style={{
          ...
          <p style={{ fontFamily: "var(--font-heading)", fontWeight: 700, fontSize: 15, color: "var(--color-header)", margin: "0 0 4px" }}>
            All caught up
          </p>
          <p style={{ fontSize: 13, color: "var(--color-text-muted)", margin: 0 }}>
                ...
                <div style={{ padding: 16 }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 8, marginBottom: 4 }}>
                        ...
                        <span style={{
                          ...
                          background: "#FFF8E1", color: "#92400E", flexShrink: 0, whiteSpace: "nowrap",
                        }}>
                          Under Review
                        </span>
                      </div>
                  ...
                  <div style={{
                    ...
                    <div style={{ textAlign: "right" }}>
                      ...
                      {l.agentPhone && (
                        <p style={{ margin: 0, fontSize: 11, color: "var(--color-text-muted)" }}>{l.agentPhone}</p>
                      )}
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      fontWeight: 600, background: "var(--color-bg)", border: "1px solid var(--color-border)",
                      color: "var(--color-text-muted)", cursor: "pointer", marginBottom: 14,
                        ...
                        <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                          {l.amenities.map((a) => (
                            <span key={a} style={{
                              ...
                              background: "var(--color-light)", color: "var(--color-primary)", fontWeight: 600,
                            }}>
                              {a.replace(/-/g, " ")}
                            </span>
                          ))}
                  ...
                  <div style={{ display: "flex", gap: 10 }}>
                    <button
                      ...
                      style={{
                        flex: 1, padding: "13px", borderRadius: 14, fontSize: 13,
                        fontWeight: 700, background: "#FEF2F2", border: "1px solid #FECACA",
                    ...
                    <button
                      ...
                      disabled={isProcessing}
                      style={{
                        flex: 2, padding: "13px", borderRadius: 14, fontSize: 13,
                        fontWeight: 700, background: "var(--color-primary)", border: "none",
        ...
        <div>
          ...
          <div style={{ background: "var(--color-card)", border: "1px solid var(--color-border)", borderRadius: 16, overflow: "hidden" }}>
            {declined.map((l, i) => (
              <div key={l.id} style={{
                padding: "12px 16px",
                borderBottom: i < declined.length - 1 ? "1px solid var(--color-border)" : "none",
                display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12,
              }}>
                <div style={{ minWidth: 0 }}>
                  <p style={{ margin: "0 0 2px", fontSize: 13, fontWeight: 600, color: "var(--color-text)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                    {l.title}
                  </p>
                  <p style={{ margin: 0, fontSize: 11, color: "var(--color-text-muted)" }}>
                    {l.agentName} · {formatDate(l.updatedAt)}
                  </p>
                </div>
      ...
      <div style={{
        ...
        <div style={{ padding: "0 16px 24px" }}>
          ...
          <p style={{ fontSize: 11, color: "var(--color-text-muted)", margin: "6px 0 20px" }}>
            This will be sent to the agent by email and in-app notification.
          </p>
          ...
          <div style={{ display: "flex", gap: 10 }}>
            ...
            <button
              ...
              style={{
                flex: 2, padding: "14px", borderRadius: 14, fontSize: 14, fontWeight: 700,
