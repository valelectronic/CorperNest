  ...
  return (
    <div style={{
      ...
      <span style={{
        ...
        fontSize: Math.round(size * 0.38), color: "#fff",
      }}>
        {initial}
      </span>
    </div>
...
export default function ProfileClient({ user }: { user: User }) {
  ...
  return (
    <div style={{ minHeight: "100dvh", background: "var(--color-bg)", paddingBottom: 88 }}>
      ...
      {/* Header */}
      <div style={{ padding: "20px 16px 16px", background: "var(--color-card)", borderBottom: "1px solid var(--color-border)" }}>
      ...
      <div style={{ padding: 16, display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        <div style={{
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <p style={{
              ...
              fontSize: 17, color: "var(--color-header)",
              overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap",
            }}>
              {user.name}
            </p>
            <p style={{
              margin: "3px 0 0", fontSize: 13, color: "var(--color-text-muted)",
              overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap",
            }}>
              {user.email}
            </p>
        ...
        <button
          ...
          style={{
            width: "100%", padding: "14px 16px",
            background: "var(--color-card)", border: "1px solid #FFCDD2",
            borderRadius: 16, display: "flex", alignItems: "center", gap: 12,
            cursor: "pointer", textAlign: "left",
          }}
        >
          ...
          <span style={{ fontSize: 15, fontWeight: 600, color: "#E53935" }}>Sign Out</span>
        </button>
